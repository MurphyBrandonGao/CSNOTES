...
![349. 两个数组的交集](/Users/gaobo/Documents/CSNOTES/typora-pic/20200818193523911.png)
...
![set哈希法](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/2020080918570417.png)
...
为什么要两个set？第一个set是为了快速查找这个数组，第二个set是为了对结果去重。
