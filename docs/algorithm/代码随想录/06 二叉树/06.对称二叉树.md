...
![101. 对称二叉树](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/20210203144607387.png)
...
![101. 对称二叉树1](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/20210203144624414.png)
...
![101.对称二叉树](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/008eGmZEly1gnwcimlj8lg30hm0bqnpd.gif)
...
在迭代法中我们使用了队列，需要注意的是这不是层序遍历，而且仅仅通过一个容器来**成对的存放要比较的元素**，知道这一本质之后就发现，用队列，用栈，甚至用数组，都是可以的。
