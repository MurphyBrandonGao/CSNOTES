...
![93.复原IP地址](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/20201123203735933.png)
...
根据[关于回溯算法，你该了解这些！ (opens new window)](https://programmercarl.com/回溯算法理论基础.html)给出的回溯算法模板：
