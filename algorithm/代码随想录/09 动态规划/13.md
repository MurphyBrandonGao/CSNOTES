...
![416.分割等和子集1](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/20210117171307407-20220502214455566.png)
...
![474.一和零](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/20210120111201512.jpg)
...
每个字符串是物品，0和1的数量是物品重量，字符串个数是物品价值，m和n是背包容量。