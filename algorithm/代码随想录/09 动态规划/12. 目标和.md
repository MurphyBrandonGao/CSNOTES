...
![494.目标和](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/20210125120743274.jpg)
...
此时 大家应该不仅想起，我们之前讲过的[回溯算法：39. 组合总和 (opens new window)](https://programmercarl.com/0039.组合总和.html)是不是应该也可以用dp来做啊？

是的，如果仅仅是求个数的话，就可以用dp，但[回溯算法：39. 组合总和 (opens new window)](https://programmercarl.com/0039.组合总和.html)要求的是把所有组合列出来，还是要使用回溯法爆搜的。
