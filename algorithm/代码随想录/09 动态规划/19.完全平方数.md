...
![279.完全平方数](https://typora-gao-pic.oss-cn-beijing.aliyuncs.com/20210202112617341.jpg)
...
如果大家认真做了昨天的题目[动态规划：322. 零钱兑换 (opens new window)](https://programmercarl.com/0322.零钱兑换.html)，今天这道就非常简单了，一样的套路一样的味道。
